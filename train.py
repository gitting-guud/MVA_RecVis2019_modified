...
#    train_set = datasets.ImageFolder('../bird_dataset/train_images',
#                         transform=TrainDataset.augmenter_func_train)
#    val_set = datasets.ImageFolder('../bird_dataset/val_images',
#                         transform=TrainDataset.augmenter_func_test)
    ...
    model = Model_(n_classes=20, input_size=image_shape,
    ...
    feature_center = torch.zeros(20, n_attentions * 2208)
...
#                        help='The output directory to store checkpoint')
    parser.add_argument('--n_attentions', default=4, type=int,
                        help='Number of attention channels')
    parser.add_argument('--image_size', nargs='+', default=(64, 64),
